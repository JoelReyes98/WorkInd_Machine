...
function getTargetedProjectOptions(project, target, context) {
    if (project.targets &&
...
function getConfigFile(project, option, context, configSection = 'build') {
...
const addHammerToConfig = (workspace, project, tree, config, context) => {
    var _a, _b;
