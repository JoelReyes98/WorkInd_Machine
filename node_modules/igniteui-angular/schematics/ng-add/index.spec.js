...
describe('ng-add schematics', () => {
    ...
    it('should properly add polyfills', () => __awaiter(void 0, void 0, void 0, function* () {
        const polyfills = `
...
`;
        ...
        yield runner.runSchematicAsync('ng-add', { polyfills: true, normalizeCss: false }, tree).toPromise();
     ...
     */
    it('should enable es5BrowserSupport on projects with ng cli version >= 7.3', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should enable web-anmations and object.entries properly on projects with ng cli version >= 7.3', () => __awaiter(void 0, void 0, void 0, function* () {
        const polyfills = `
/** IE10 and IE11 requires the following for NgClass support on SVG elements */
// import 'classlist.js';  // Run \`npm install --save classlist.js\`.
