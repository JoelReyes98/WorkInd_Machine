...
function enablePolyfills(tree, context) {
    ...
    const targetFile = dependency_handler_1.getConfigFile(project, 'polyfills', context);
...
function readInput(options) {
    return (tree, context) => {
        if (options.polyfills) {
            ...
            const project = workspace.projects[workspace.defaultProject];
            const polyfillsFile = dependency_handler_1.getConfigFile(project, 'polyfills', context);
